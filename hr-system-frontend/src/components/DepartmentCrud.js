...
const [departments, setDepartments] = useState([]);
  ...
  async function save(event) {
    ...
    try {
      await axios.post("https://localhost:7122/api/departments/AddDepartment", {     
        name: name,
       
      });
      alert("Department Registation Successfully");
          setId("");
          setName("");
  ...
  await axios.delete("https://localhost:7122/api/departments/DeleteDepartment/" + id);
  ...
  await axios.patch("https://localhost:7122/api/departments/UpdateDepartment/"+ departments.find((u) => u.id === id).id || id,
        {
        id: id,
        name: name,
                          ...
                          <ul className={style} id="accordionSidebar">
                            ...
                            {/*   <div className="text-center d-none d-md-inline">
                              ...
                              <div className="sidebar-card d-none d-lg-flex">
                                  ...
                                  <a className="btn btn-success btn-sm">Launching a new project</a>
                              </div>
                              ...
                              <div id="content">
                                  ...
                                  <div className="container-fluid">
                                      ...
                                      <div className="d-sm-flex align-items-center justify-content-between mb-4">
                                          <h1 className="h3 mb-0 text-gray-800">Departments Dashboard</h1>
                                          ...
                                          {/*   <!-- Area Chart --> */}
                                              <div className="card shadow mb-4">
                                                  ...
                                                  <div
                                                      ...
                                                      <h6 className="m-0 font-weight-bold text-primary">List All Department</h6>
                                                  ...
                                                  <div className="card-body">
                                                    <table class="table">
                                                      ...
                                                      {departments.map(function fn(department) {
                                                              return (
                                                      <tbody>
                                                        <tr>
                                                        <th scope="row">{department.id} </th>
                                                            <td>{department.name}</td> 
                                                                  <td>
                                                                    ...
                                                                    <button type="button" class="btn btn-secondary" onClick={() => editDepartment(department)} >Edit</button>
                                                                      <button type="button" class="btn btn-warning" onClick={() => DeleteDepartment(department.id)}> Delete</button>
                                                                    </div> 
                                                                    </td>
                                                                  </tr>
                                                                  </tbody>
                                              ...
                                              <div className="card shadow mb-4">
                                                  <div className="card-header py-3">
                                                      <h6 className="m-0 font-weight-bold text-primary">Add or Update Department</h6>
                                                  </div>
                                                  <div className="card-body">                                     
                                                  <form>
                                                            ...
                                                            <div>
                                                            <dic><button class="btn btn-primary mt-4" onClick={save}>    Register
                                                              </button></dic> 
                                                            
                                                            <div> <button class="btn btn-secondary mt-4" onClick={update}>
                                                                Update
                                                              </button></div> 
                                                            </div>
                                                          </form>
